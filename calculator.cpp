 ...
 *  Возможность обработки скобок {} и (), чтобы выражение {(4+5)*6}/(3+4) стало корректным.
 *  Также добавлена проверка на количество скобок, 
 *   если не хватает открывающих или закрывающих скобок, программа предупредит.
 *
